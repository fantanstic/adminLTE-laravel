...
class CreateTaskListNormalCountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('task_list_normal_counts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('task_list_normal_counts');
    }
}
