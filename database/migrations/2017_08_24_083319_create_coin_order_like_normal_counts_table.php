...
class CreateCoinOrderLikeNormalCountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('coin_order_like_normal_counts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('coin_order_like_normal_counts');
    }
}
