...
class CreateGetFreeCoinNormalCountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('get_free_coin_normal_counts', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('get_free_coin_normal_counts');
    }
}
