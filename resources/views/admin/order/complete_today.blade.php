...
@section('content')
    <section class="content-header">
        <h1>
            今日已完成任务列表
            <small>completetodayd tasks list</small>
        </h1>
    </section>
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="form-inline pull-right">
                                <form action="{{
                                \Illuminate\Support\Facades\Route::currentRouteName() == 'admin.v2.order.completetoday'?
                                route('admin.v2.order.completetoday'): route('admin.v1.order.completetoday')
                                 }}" method="get">
                                    <fieldset>
                                ...
                                route('admin.v2.order.completetoday'): route('admin.v1.order.complete')
