                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="form-inline pull-right">
                                <form action="{{
                                \Illuminate\Support\Facades\Route::currentRouteName() == 'admin.v2.order.index'?
                                route('admin.v2.order.index'): route('admin.v1.order.index')
                                 }}" method="get">
                                    <fieldset>
                        ...
                        <table id="task" class="table table-bordered table-hover">
                            ...
                            @foreach($taskList as $task)
                                <tr>
                                    ...
                                    <td>
                                        @if($task->stick == 0)
                                        <button class="btn btn-info btn-sm stick-task" data-url="{{
                                \Illuminate\Support\Facades\Route::currentRouteName() == 'admin.v2.order.index'?
                                route('admin.v2.order.update', $task->id): route('admin.v1.order.update', $task->id)
                                 }}">
                                            <span class="i fa fa-level-up"></span>
                                        </button>
                                        @else
                                            <button class="btn btn-warning btn-sm stick-task" data-url="{{
                                \Illuminate\Support\Facades\Route::currentRouteName() == 'admin.v2.order.index'?
                                route('admin.v2.order.down', $task->id): route('admin.v1.order.down', $task->id)
                                 }}">
