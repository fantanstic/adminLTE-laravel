                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="form-inline pull-right">
                                <form action="{{ route('admin.v10.order.index')}}" method="get">
                                    <fieldset>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="{{ route('admin.v10.order.index') }}" class="btn btn-warning"><i class="fa fa-undo"></i></a>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
                        ...
                        <table id="task" class="table table-bordered table-hover">
                            ...
                            @foreach($taskList as $task)
                                <tr>
                                    ...
                                    <td>
                                        @if($task->stick == 0)
                                            <button class="btn btn-info btn-sm stick-task" data-url="{{route('admin.v10.order.update', $task->id)}}">
                                                <span class="i fa fa-level-up"></span>
                                            </button>
                                        @else
                                            <button class="btn btn-warning btn-sm stick-task" data-url="{{route('admin.v10.order.down', $task->id)}}">
