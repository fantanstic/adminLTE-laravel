                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <div class="form-inline pull-right">
                                <form action="{{ route('admin.v9.project.index') }}" method="get">
                                    <fieldset>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="{{ route('admin.v9.project.index') }}" class="btn btn-warning"><i class="fa fa-undo"></i></a>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
                    ...
                    <div class="box-body">
                        <table id="pay" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th title="">one_week_01</th>
                                <th title="">one_month_01</th>
                                <th title="">three_months_01</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach($pay_content as $pay)
                                <tr>
                                    ...
                                    <td>{{ $pay->one_week_01 }}</td>
                                    <td>{{ $pay->one_month_01 }}</td>
                                    <td>{{ $pay->three_months_01 }}</td>
                                    <td></td>
                                </tr>
                            @endforeach
                            </tbody>
